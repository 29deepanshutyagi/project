...
MEDIA_ROOT = os.path.join(BASE_DIR, 'images')  # Specify the absolute path where images will be stored
MEDIA_URL = '/images/'  # Specify the URL prefix for serving media files
